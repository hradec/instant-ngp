...
public:
	...
	pybind11::dict vdb(Eigen::Vector3i res3d = Eigen::Vector3i::Constant(128), float thresh=0.0f, BoundingBox aabb = BoundingBox{Eigen::Vector3f::Zero(), Eigen::Vector3f::Ones()});
